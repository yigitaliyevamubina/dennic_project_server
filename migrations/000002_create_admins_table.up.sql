...
VALUES
  ...
  ('123e4567-e89b-12d3-a456-426614174001', 1, 'admin',    'Bobomurod', 'Artigaliyev', '2000-08-30', '+9998994767316', 'msrbobo@example.com', 'BoBo1234', 'male', 1000.00, 'Bobomurod bio', '2024-01-01', 'refresh_token1', CURRENT_TIMESTAMP, 'https://example.com/admin1.jpg'),
  ('123e4567-e89b-12d3-a456-426614174010', 10, 'admin', 'Toraxon', 'Joraxonov', '2003-05-05', '+998950230605', 'torakhonoffical@gmail.com', 'Toraxon', 'male', 10000.00, 'Toraxon bio', '2024-01-01', 'refresh_token10', CURRENT_TIMESTAMP, 'https://example.com/superadmin10.jpg');;